...
#ifndef __EAViewEngine_i_h__
#define __EAViewEngine_i_h__
...
#ifndef __EAViewEngineLib_LIBRARY_DEFINED__
#define __EAViewEngineLib_LIBRARY_DEFINED__

/* library EAViewEngineLib */
/* [custom][version][uuid] */ 


EXTERN_C const IID LIBID_EAViewEngineLib;

EXTERN_C const CLSID CLSID_CompReg;

#ifdef __cplusplus

class DECLSPEC_UUID("E9B17698-FA7F-4316-B3B1-24F714F7A7B2")
CompReg;
#endif
#endif /* __EAViewEngineLib_LIBRARY_DEFINED__ */
