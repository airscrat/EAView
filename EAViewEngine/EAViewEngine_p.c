...
/* at Thu Aug 29 13:24:53 2013
 */
/* Compiler settings for EAViewEngine.idl:
...
typedef struct _EAViewEngine_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } EAViewEngine_MIDL_TYPE_FORMAT_STRING;

typedef struct _EAViewEngine_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } EAViewEngine_MIDL_PROC_FORMAT_STRING;

typedef struct _EAViewEngine_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } EAViewEngine_MIDL_EXPR_FORMAT_STRING;
...
extern const EAViewEngine_MIDL_TYPE_FORMAT_STRING EAViewEngine__MIDL_TypeFormatString;
extern const EAViewEngine_MIDL_PROC_FORMAT_STRING EAViewEngine__MIDL_ProcFormatString;
extern const EAViewEngine_MIDL_EXPR_FORMAT_STRING EAViewEngine__MIDL_ExprFormatString;
...
static const EAViewEngine_MIDL_PROC_FORMAT_STRING EAViewEngine__MIDL_ProcFormatString =
    {
        0,
        {
...
static const EAViewEngine_MIDL_TYPE_FORMAT_STRING EAViewEngine__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUBLESS_PROXY_INFO IComponentRegistrar_ProxyInfo =
    {
    &Object_StubDesc,
    EAViewEngine__MIDL_ProcFormatString.Format,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    EAViewEngine__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _EAViewEngine_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IComponentRegistrarProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _EAViewEngine_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IComponentRegistrarStubVtbl,
    0
};

PCInterfaceName const _EAViewEngine_InterfaceNamesList[] = 
{
    "IComponentRegistrar",
    0
};

const IID *  const _EAViewEngine_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _EAViewEngine_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _EAViewEngine, pIID, n)

int __stdcall _EAViewEngine_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_EAViewEngine_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo EAViewEngine_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _EAViewEngine_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _EAViewEngine_StubVtblList,
    (const PCInterfaceName * ) & _EAViewEngine_InterfaceNamesList,
    (const IID ** ) & _EAViewEngine_BaseIIDList,
    & _EAViewEngine_IID_Lookup, 
    1,
    2,
